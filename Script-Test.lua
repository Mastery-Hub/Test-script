local Config = {
    ['Key'] = 'Mastery_103jfo293g9s82949gi29i59g9299',
    ['Key'] = 'Mastery_103858293j5948djfjgo1948582j5h',
    ['Key'] = 'Mastery_10485859294858392u4gugj249y8',
    ['Link Key'] = {
        ['Key 1'] = 'https://mastery-hub.github.io/MasteryHub/',
        ['Key 2'] = '',
    },
}
...
Status.Text = "MASTERY HUB [FREEMIUM]"
...
Pattern.Image = "rbxassetid://100265371620585"
...
ImageLabel.Image = "rbxassetid://100265371620585"
...
local Window = Fluent:CreateWindow({
    Title = "Mastery Hub-Auto Hop [FREEMIUM] ",
    SubTitle = "| by Qminhdz",
    TabWidth = 110,
...
Tabs.Servers:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/kuYGjVh3")) 
        end
})
...
Tabs.Servers:AddButton({
    ...
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://www.youtube.com/@master_sigma_29"))
    end
})
